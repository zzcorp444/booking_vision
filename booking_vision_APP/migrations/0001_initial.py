...
class Migration(migrations.Migration):
    ...
    operations = [
        # Basic models first (no foreign keys to other app models)
        ...
        # Models that depend on Property
        migrations.CreateModel(
            name='Booking',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [
                    models.UniqueConstraint(fields=('rental_property', 'channel'), name='unique_property_channel'),
                ],
            },
        ),

        # Additional AI models (can be in a separate migration if needed)
        migrations.CreateModel(
            name='MarketData',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
            ...
            options={
                ...
                'ordering': ['-date'],
                'constraints': [
                    models.UniqueConstraint(fields=('location', 'date'), name='unique_location_date'),
                ],
            },
        ),
