"""
Django settings for booking_vision project.
"""
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'booking_vision_APP' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'booking_vision.wsgi.application'
ASGI_APPLICATION = 'booking_vision.asgi.application'

# Database
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://zz_corp:jzknGixZCIgz6lpW8vSqBqpuzEhHlRqF@dpg-d1m6pcumcj7s739to730-a/asia_immo_db_00_nirg'),
        conn_max_age=600,
